<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta eliminato il tuo profilo, tutti i dati e le risorse verranno cancellati definitivamente. Prima di eliminare il tuo account, assicurati di aver scaricato tutti i tuoi dati.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta eliminato il tuo profilo, tutti i dati e le risorse verranno cancellati definitivamente. Per confermare la cancellazione, inserisci la tua password.') }}
                    </p>
                </div>
